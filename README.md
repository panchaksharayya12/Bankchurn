...
**Project Repository:** https://github.com/panchaksharayya12/Bankchurn.git  
...
- **Live Web Portal (Scrolltide Helix 3D WebGL):** http://localhost:3000
- **Live Streamlit Analytics Application:** http://localhost:8501
- **PowerPoint Presentation (10 Slides):** [Presentation_Customer_Segmentation_and_Churn.pptx](Presentation_Customer_Segmentation_and_Churn.pptx)
- **Presentation Deck Markdown Companion:** [Presentation_Slides.md](Presentation_Slides.md)
- **Formal Academic Research Paper:** [Research_Paper.md](Research_Paper.md)
- **Academic Review Paper (Methodologies & Literature):** [Review_Paper_Banking_Churn_Literature_and_Methodologies.md](Review_Paper_Banking_Churn_Literature_and_Methodologies.md)
- **Comprehensive Technical Report:** [Comprehensive_Technical_Report.md](Comprehensive_Technical_Report.md)
- **Executive Summary for Regulators & Supervisors:** [Executive_Summary_Government_Stakeholders.md](Executive_Summary_Government_Stakeholders.md)
- **Audited Dataset (10,000 Accounts):** [dataset.csv](dataset.csv)
- **Main Web Application File:** [index.html](index.html)
- **Streamlit Python Backend:** [app.py](app.py)
...
- **GitHub Repository:** https://github.com/panchaksharayya12/Bankchurn.git
